...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS(f"Loaded {patients} patients, {regimens} regimens, {modifications} modifications, {visits} visits, {predictions} predictions"))
            ...
            for row in reader:
                Patient.objects.update_or_create(
                    ...
                    defaults={
                        ...
                        "baseline_date": row.get("baseline_date") or None,
                    },
                )
                count += 1
        return count
