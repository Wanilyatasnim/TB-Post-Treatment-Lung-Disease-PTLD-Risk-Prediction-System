            ...
            for row in reader:
                Patient.objects.update_or_create(
                    ...
                    defaults={
                        ...
                        "chest_x_ray": row.get("chest_x_ray", ""),
                        "tuberculin_test": row.get("tuberculin_test", ""),
                        "clinical_form": row.get("clinical_form", ""),
                        ...
                        "aids_comorbidity": row.get("aids_comorbidity") in ("True", "true", "1", "yes"),
                        "alcoholism_comorbidity": row.get("alcoholism_comorbidity") in ("True", "true", "1", "yes"),
                        "mental_disorder_comorbidity": row.get("mental_disorder_comorbidity") in ("True", "true", "1", "yes"),
                        "drug_addiction_comorbidity": row.get("drug_addiction_comorbidity") in ("True", "true", "1", "yes"),
                        "other_comorbidity": row.get("other_comorbidity", ""),
                        "bacilloscopy_sputum": row.get("bacilloscopy_sputum", ""),
                        "bacilloscopy_sputum_2": row.get("bacilloscopy_sputum_2", ""),
                        "bacilloscopy_other": row.get("bacilloscopy_other", ""),
                        "sputum_culture": row.get("sputum_culture", ""),
                        "bacilloscopy_month_1": row.get("bacilloscopy_month_1", ""),
                        "bacilloscopy_month_2": row.get("bacilloscopy_month_2", ""),
                        "bacilloscopy_month_3": row.get("bacilloscopy_month_3", ""),
                        "bacilloscopy_month_4": row.get("bacilloscopy_month_4", ""),
                        "bacilloscopy_month_5": row.get("bacilloscopy_month_5", ""),
                        "bacilloscopy_month_6": row.get("bacilloscopy_month_6", ""),
                        "rifampicin": row.get("rifampicin") in ("True", "true", "1", "yes"),
                        "isoniazid": row.get("isoniazid") in ("True", "true", "1", "yes"),
                        "ethambutol": row.get("ethambutol") in ("True", "true", "1", "yes"),
                        "streptomycin": row.get("streptomycin") in ("True", "true", "1", "yes"),
                        "pyrazinamide": row.get("pyrazinamide") in ("True", "true", "1", "yes"),
                        "ethionamide": row.get("ethionamide") in ("True", "true", "1", "yes"),
                        "other_drugs": row.get("other_drugs", ""),
                        "supervised_treatment": row.get("supervised_treatment") in ("True", "true", "1", "yes"),
                        "occupational_disease": row.get("occupational_disease") in ("True", "true", "1", "yes"),
